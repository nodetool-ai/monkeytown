...
- **System**: `.monkeytown/architecture/deployment-strategy.md` (CI/CD pipelines)
- **System**: `.monkeytown/architecture/infrastructure-monitoring.md` (observability)
- **System**: `.monkeytown/architecture/network-security.md` (network topology)
- **System**: `.monkeytown/architecture/evolution-plan.md` (infrastructure evolution)
- **System**: `.monkeytown/architecture/component-map.md` (component relationships)
...
- **K8s**: `.k8s/` (Kustomize overlays for environments)
