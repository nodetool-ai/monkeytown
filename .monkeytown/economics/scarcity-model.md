...
### Category 1: Time-Locked Scarcity

**Definition:** Items available only during specific windows, then never again.

**Implementation:**
- Limited-time events (always 14+ days advance notice)
- Seasonal items (available every year, same time)
- Anniversary items (one-time, never returns)

**The No-FOMO Guarantee:**
- All limited items clearly marked with end date
...
| Seasonal items | Quarterly | 30 days |
| Anniversary items | Annual | 60 days |
| Milestone celebrations | As earned | Immediate |

### Category 2: Effort-Locked Scarcity

**Definition:** Items require significant investment to obtain.

**Implementation:**
- High BANANA costs for prestigious cosmetics
- Multi-step achievement chains
...
Hard (1-2 weeks)     → 1,500-3,000 BANANA
...
**Definition:** Items available only to players with established reputation.

**Implementation:**
- KUDOS thresholds for exclusive cosmetics
- Founder's Pass benefits for supporters
- Beta access for engaged testers
...
| Contributor | 100+ | Contributor cosmetics |
| Recognized | 500+ | Early feature access |
...
- No "pity mechanics" that create false scarcity
- True randomness with transparent probability
...
**BANANA Supply:**
- Maximum balance: 100,000 BANANA
- Soft cap warning: 80,000 BANANA
- Sink mechanisms activate above 80,000
- Inflation target: 2-3% annually

**KUDOS Supply:**
- No maximum balance
- Daily give limit: 50 KUDOS
...
**Healthy Demand Indicators:**
- 40-60% of players have partially completed collections
...
## Seasonal Scarcity Calendar

### Monthly Events

| Event | Duration | Scarcity Type | Advance Notice |
|-------|----------|---------------|----------------|
...
**On Every Scarcity Element:**
1. Total quantity (if limited)
2. Remaining quantity (if trackable)
...
Players can access a dashboard showing:
- All limited items and their status
...
|--------|---------------|-------------------|
| Collection completion | 40-70% partial | Introduce new items |
| BANANA at cap | <10% of players | Increase cosmetic variety |
...
|---------|-----------|----------|
| Artificial scarcity | Low participation, high complaint | Increase availability |
...
1. **Intentionality** — Scarcity serves purpose, not manipulation
2. **Transparency** — All scarcity visible and explained
